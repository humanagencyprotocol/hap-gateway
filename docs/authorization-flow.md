...
2. **Bounds** — Set field constraints: `amount_max: 100`, `currency: USD`, `target_env: production`
...
[spend-routine] spend@0.3 (28 min remaining)
  Bounds: amount_max: 100, currency: USD, action_type: charge, target_env: production
...
4. Set bounds: `amount_max: 100`, `currency: USD`, `action_type: charge`, `target_env: production`
